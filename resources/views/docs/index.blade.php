...
<body class="flex flex-col min-h-[100vh] relative">
    <x-app-layout>
        <x-slot name="header" >
            <div class="flex">
        ...
        <main class="z-40">
            ...
            <div class="md:flex md:container mx-auto justify-between">
                <section class="text-gray-600 body-font relative bg-white w-4/12 rounded drop-shadow" style="height:500px;">
                    <form action="POST">
                ...
                <section class="w-7/12">
                    <ul class="mb-10">
                        ...
                        <li>
                            <div class="bg-white mt-4 p-4 rounded drop-shadow">
                                <h1 class="font-bold">タイトル</h1>
                                <div>てきすと</div>
                                <div class="flex">
                                    <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
